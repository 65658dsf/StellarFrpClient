...
class  reg_main:
    def __init__(self,root,isTKroot = True,params=None):
        ...
        Fun.G_UICommandDictionary[uiName]=reg_main_cmd
        Fun.Register(uiName,'root',root)
        style = reg_main_sty.SetupStyle(isTKroot)
        if isTKroot == True:
        ...
        LabelButton_2.SetCommandFunction(reg_main_cmd.login_onCommand,self.uiName,"login")
        ...
        Fun.SetControlPlace(uiName,'PyMe_LabelButton_3',0.7298611111111111,0.21777777777777776,0.13541666666666666,0.05333333333333334,'nw',True,True)
        ...
        LabelButton_11.SetCommandFunction(reg_main_cmd.LabelButton_3_onCommand,self.uiName,"LabelButton_3")
        ...
        Fun.SetControlPlace(uiName,'PyMe_LabelButton_14',0.6270833333333333,0.6377777777777778,0.1931,0.05333,'nw',True,True)
        LabelButton_14.Redraw()
        LabelButton_14.SetCommandFunction(reg_main_cmd.reg_bt_onCommand,self.uiName,"reg_bt")
        ...
        Timer_17 = Fun.Timer(1000,lambda:reg_main_cmd.Timer_1_onTimer(uiName,"Form_1"))
        #Timer_17.xy(899,80)
