...
class  FREE:
    def __init__(self,root,isTKroot = True,params=None):
        ...
        Fun.G_UICommandDictionary[uiName]=FREE_cmd
        Fun.Register(uiName,'root',root)
        style = FREE_sty.SetupStyle(isTKroot)
        if isTKroot == True:
        ...
        Label_2 = tkinter.Label(Form_1,text="免费隧道")
        ...
        Label_7 = tkinter.Label(Form_1,text="10000-17999")
        ...
        LabelButton_5.SetCommandFunction(FREE_cmd.setting_onCommand,self.uiName,"setting")
        #Inital all element's Data 
        Fun.InitElementData(uiName)
        #Call Form_1's OnLoad Function
        Fun.RunForm1_CallBack(uiName,"Load",FREE_cmd.Form_1_onLoad)
