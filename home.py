...
class  home:
    def __init__(self,root,isTKroot = True,params=None):
        ...
        style = home_sty.SetupStyle(isTKroot)
        if isTKroot == True:
        ...
        Label_2 = tkinter.Label(Form_1,text="你好，NingMeng123")
        ...
        Fun.Register(uiName,'PyMe_Frame_6',Frame_6,'ad_main')
        Fun.SetControlPlace(uiName,'PyMe_Frame_6',0.01935483870967742,0.3244444444444444,0.6451612903225806,0.6488888888888888,'nw',True,True)
        Frame_6.configure(bg = "#CCCCCC")
        ad_main_6 = ad_main.ad_main(Frame_6,False)
        Fun.Register(uiName,'ad_main_6',ad_main_6)
