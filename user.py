...
class  user:
    def __init__(self,root,isTKroot = True,params=None):
        ...
        style = user_sty.SetupStyle(isTKroot)
        if isTKroot == True:
        ...
        Label_4 = tkinter.Label(Form_1,text="ID-隧道名")
        ...
        Label_5 = tkinter.Label(Form_1,text="隧道类型")
        ...
        Label_6 = tkinter.Label(Form_1,text="远程端口")
        ...
        Label_7 = tkinter.Label(Form_1,text="所属节点")
        ...
        LabelButton_17.SetCommandFunction(user_cmd.LabelButton_1_onCommand,self.uiName,"LabelButton_1")
        LabelButton_19= EXUIControl.LabelButton(Form_1)
        Fun.Register(uiName,'PyMe_LabelButton_19',LabelButton_19,'LabelButton_2')
        LabelButton_19.SetText("上一页")
        LabelButton_19.SetBGColor("#F0F0F0")
        LabelButton_19.SetFGColor("#000000")
        LabelButton_19_TitleFont=tkinter.font.Font(family='Microsoft YaHei UI', size=18,weight='normal',slant='roman',underline=0,overstrike=0)
        LabelButton_19.SetFont(LabelButton_19_TitleFont)
        LabelButton_19.SetBGImage("Button.png")
        ...
        Fun.SetControlPlace(uiName,'PyMe_LabelButton_19',0.1032258064516129,0.8944444444444445,0.12903225806451613,0.05333333333333334,'nw',True,True)
        LabelButton_19.Redraw()
        LabelButton_19.SetCommandFunction(user_cmd.LabelButton_2_onCommand,self.uiName,"LabelButton_2")
        LabelButton_20= EXUIControl.LabelButton(Form_1)
        Fun.Register(uiName,'PyMe_LabelButton_20',LabelButton_20,'LabelButton_3')
        LabelButton_20.SetText("下一页")
        LabelButton_20.SetBGColor("#F0F0F0")
        LabelButton_20.SetFGColor("#000000")
        LabelButton_20_TitleFont=tkinter.font.Font(family='Microsoft YaHei UI', size=18,weight='normal',slant='roman',underline=0,overstrike=0)
        ...
        LabelButton_20.SetFGColor_Hover("#000000")
        LabelButton_20.SetBGColor_Click("#AAAAAA")
        LabelButton_20.SetFGColor_Click("#FF0000")
        Fun.SetControlPlace(uiName,'PyMe_LabelButton_20',0.7677419354838709,0.8944444444444445,0.12903225806451613,0.05333333333333334,'nw',True,True)
        LabelButton_20.Redraw()
        LabelButton_20.SetCommandFunction(user_cmd.LabelButton_3_onCommand,self.uiName,"LabelButton_3")
        LabelButton_21= EXUIControl.LabelButton(Form_1)
        Fun.Register(uiName,'PyMe_LabelButton_21',LabelButton_21,'LabelButton_4')
        LabelButton_21.SetText("检测联机延迟")
        LabelButton_21.SetBGColor("#FFFFFF")
        LabelButton_21.SetFGColor("#000000")
        LabelButton_21_TitleFont=tkinter.font.Font(family='Microsoft YaHei UI', size=16,weight='normal',slant='roman',underline=0,overstrike=0)
        ...
        Fun.SetControlPlace(uiName,'PyMe_LabelButton_21',0.8330645161290322,0.0,0.15161290322580645,0.05333333333333334,'nw',True,True)
        LabelButton_21.Redraw()
        LabelButton_21.SetCommandFunction(user_cmd.LabelButton_4_onCommand,self.uiName,"LabelButton_4")
        Timer_18 = Fun.Timer(1000,lambda:user_cmd.Timer_1_onTimer(uiName,"Form_1"))
        #Timer_18.xy(18,47)
        ...
        Fun.RunForm1_CallBack(uiName,"Load",user_cmd.Form_1_onLoad)
